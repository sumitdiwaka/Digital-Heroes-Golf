    ...
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:24 }}>
      ...
      <div style={{ width:'100%', maxWidth:400, position:'relative' }} className="animate-fade-up">
        ...
        <div style={{ textAlign:'center', marginBottom:40 }}>
          ...
          <h1 style={{ fontFamily:'var(--font-display)', fontSize:26, fontWeight:800, marginBottom:6 }}>Sign in</h1>
          <p style={{ fontSize:14, color:'var(--text-3)' }}>Access your GolfGives account</p>
        </div>
        ...
        <div className="card">
          <form onSubmit={submit} style={{ display:'flex', flexDirection:'column', gap:16 }}>
            ...
            <div>
              ...
              <input name="password" type="password" placeholder="••••••••" value={form.password} onChange={handle} className="input-field" required />
            </div>
